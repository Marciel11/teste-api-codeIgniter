...
return [
    ...
    'is_unique'             => 'O {field} já existe cadastrado.',
    ...
    'max_length'            => 'O {field} campo não pode exceder {param} caracteres de comprimento.',
    // 'min_length'            => 'The {field} field must be at least {param} characters in length.',
    'min_length'            => 'O {field} campo deve ter pelo menos {param} caracteres em comprimento.',
    ...
    'required'              => 'O {field} campo é obrigatório.',
